...
function ready() {
	...
	let addToCartButtons = document.querySelectorAll('.menu .menu-container .card .card-btn.btn-cart');
...
function removeCartItem(event) {
	...
	let products = document.querySelectorAll('.menu .menu-container .card')
